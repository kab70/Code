...
namespace DefTrack
{
    public partial class AssignDefect : System.Web.UI.Page
    {
        ...
        protected void AssignDefect_Button_Click(object sender, EventArgs e)
        {
            ...
            cmd.ExecuteNonQuery();
            SqlCommand cmd2 = new SqlCommand("INSERT INTO NOTES (DIMID_DEFECT, DIMID_EMPLOYEE, DATE_ENTERED, INITIAL_MANAGER_NOTE, NOTE_DESCRIPTION) " +
