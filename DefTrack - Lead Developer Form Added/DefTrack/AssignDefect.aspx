            ...
            <table style="width: 100%">
                <tr>
                    <td class="width: 33%">Status: &nbsp; &nbsp;
                        <asp:DropDownList ID="DD_Status" runat="server" cssClass="field_color" DataSourceID="getStatus" DataTextField="STATUS_DESCRIPTION" DataValueField="DIMID_STATUS">
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="getStatus" runat="server" ConnectionString="<%$ ConnectionStrings:DefTrackConnectionString %>" SelectCommand="SELECT * FROM [STATUS]"></asp:SqlDataSource>
                    </td>
            ...
            <table style="width: 100%">
                <tr>
                    <td class="width: 33%">Update Status: &nbsp;
                        <asp:DropDownList ID="DD_LDStatus" runat="server" DataSourceID="getStatus" DataTextField="STATUS_DESCRIPTION" DataValueField="DIMID_STATUS">
                        </asp:DropDownList>
                        &nbsp;
                    </td>
...
WHERE R.ROLE_DESCRIPTION IN ('Lead Developer','Developer')"></asp:SqlDataSource>
                ...
                <tr>
                    <td colspan="3" style="height: 106px">Management Notes:<br /><asp:TextBox ID="T_LeadDeveloperNotes" runat="server" cssClass="field_color" TextMode="MultiLine" Rows="5" Width="100%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>Assigned By:&nbsp;
        ...
        <asp:Panel ID="DeveloperUpdatePanel" runat="server">            
            <table class="defect_layout">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DD_StatusUpdate" runat="server" DataSourceID="updateStatus" DataTextField="STATUS_DESCRIPTION" DataValueField="DIMID_STATUS"></asp:DropDownList>
                        <asp:SqlDataSource ID="updateStatus" runat="server" ConnectionString="<%$ ConnectionStrings:DefTrackConnectionString %>" SelectCommand="SELECT * FROM [STATUS] WHERE ([STATUS_DESCRIPTION] &lt;&gt; @STATUS_DESCRIPTION)">
                            <SelectParameters>
                                <asp:Parameter DefaultValue="New" Name="STATUS_DESCRIPTION" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </td>
